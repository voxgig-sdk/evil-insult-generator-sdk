...
// EvilInsultGenerator SDK rbac feature
...
class EvilInsultGeneratorRbacFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _required(EvilInsultGeneratorContext $ctx): ?string
    {
    ...
    private function _reject(EvilInsultGeneratorContext $ctx, string $required): void
    {
    ...
    private function _track(EvilInsultGeneratorContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
