...
// EvilInsultGenerator SDK netsim feature
...
class EvilInsultGeneratorNetsimFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _simulate(EvilInsultGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EvilInsultGeneratorContext $ctx, array $applied): void
    {
        $client = $this->client;
