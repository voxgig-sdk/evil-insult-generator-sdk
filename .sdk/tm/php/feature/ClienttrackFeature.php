...
// EvilInsultGenerator SDK clienttrack feature
...
class EvilInsultGeneratorClienttrackFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    public function PostConstruct(EvilInsultGeneratorContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'EvilInsultGenerator-SDK';
