...
// EvilInsultGenerator SDK telemetry feature
...
class EvilInsultGeneratorTelemetryFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _close(EvilInsultGeneratorContext $ctx, bool $ok): void
    {
