...
// EvilInsultGenerator SDK metrics feature
...
class EvilInsultGeneratorMetricsFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _record(EvilInsultGeneratorContext $ctx, bool $ok): void
    {
