...
// EvilInsultGenerator SDK ratelimit feature
...
class EvilInsultGeneratorRatelimitFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _acquire(EvilInsultGeneratorContext $ctx): void
    {
    ...
    private function _track(EvilInsultGeneratorContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
