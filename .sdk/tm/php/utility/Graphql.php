...
// EvilInsultGenerator SDK utility: graphql
//
...
class EvilInsultGeneratorGraphql
{
    ...
    // equivalent.
    public static function body(EvilInsultGeneratorContext $ctx): mixed
    {
    ...
    public static function errors(EvilInsultGeneratorContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
