...
import (
	...
	vs "github.com/voxgig-sdk/evil-insult-generator-sdk/go/utility/struct"
)

type GenerateInsultEntity struct {
	name    string
	client  *core.EvilInsultGeneratorSDK
...
func NewGenerateInsultEntity(client *core.EvilInsultGeneratorSDK, entopts map[string]any) *GenerateInsultEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GenerateInsultEntity) GetName() string { return e.name }
...
func (e *GenerateInsultEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GenerateInsultEntity) Deleted() bool {
	return e.deleted
}


func (e *GenerateInsultEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGenerateInsultEntity(e.client, opts)
}

func (e *GenerateInsultEntity) Data(args ...any) any {
...
func (e *GenerateInsultEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an GenerateInsult; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *GenerateInsultEntity) DataTyped(data ...GenerateInsult) GenerateInsult {
	if len(data) > 0 {
		return typedFrom[GenerateInsult](e.Data(asMap(data[0])))
	}
	return typedFrom[GenerateInsult](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through GenerateInsult (all fields
// optional at the wire level).
func (e *GenerateInsultEntity) MatchTyped(match ...GenerateInsult) GenerateInsult {
	if len(match) > 0 {
		return typedFrom[GenerateInsult](e.Match(asMap(match[0])))
	}
	return typedFrom[GenerateInsult](e.Match())
}
...
func (e *GenerateInsultEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GenerateInsultEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// GenerateInsultLoadMatch and returns an GenerateInsult. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *GenerateInsultEntity) LoadTyped(reqmatch GenerateInsultLoadMatch, ctrl map[string]any) (GenerateInsult, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return GenerateInsult{}, err
	}
	return typedFrom[GenerateInsult](res), nil
}



func (e *GenerateInsultEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GenerateInsultEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GenerateInsultEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GenerateInsultEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GenerateInsultEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
