...
func generate_insultBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("EVIL_INSULT_GENERATOR_TEST_GENERATE_INSULT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["EVIL_INSULT_GENERATOR_TEST_GENERATE_INSULT_ENTID"])
