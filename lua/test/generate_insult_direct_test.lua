...
describe("GenerateInsultDirect", function()
  it("should direct-load-generate_insult", function()
    local setup = generate_insult_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-generate_insult", setup.live and "live" or "unit")
