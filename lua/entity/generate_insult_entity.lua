...
local GenerateInsultEntity = {}
GenerateInsultEntity.__index = GenerateInsultEntity


function GenerateInsultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, GenerateInsultEntity)
  self._name = "generate_insult"
  self._client = client
...
function GenerateInsultEntity:get_name()
  return self._name
end


function GenerateInsultEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return GenerateInsultEntity.new(self._client, opts)
end
...
function GenerateInsultEntity:mark_deleted()
  self._deleted = true
end


function GenerateInsultEntity:deleted()
  return true == self._deleted
end


function GenerateInsultEntity:data_set(args)
  if args ~= nil then
...
function GenerateInsultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function GenerateInsultEntity:match_set(args)
  if args ~= nil then
...
function GenerateInsultEntity:match_get()
...
function GenerateInsultEntity:stream(action, args, callopts)
...
function GenerateInsultEntity:_run_op(ctx, post_done)
  local utility = self._utility
