// Command EvilInsultGenerator-mcp is an MCP server exposing the EvilInsultGenerator
// SDK as MCP tools.
//
// Two tools are registered:
//
//	EvilInsultGenerator_list  — list records of an entity
//	EvilInsultGenerator_load  — load a single record of an entity
//
