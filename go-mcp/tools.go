...
type Args struct {
	Entity string         `json:"entity" jsonschema:"generate_insult"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.EvilInsultGeneratorSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "evil-insult-generator_list",
		Description: "List records from EvilInsultGenerator. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "evil-insult-generator_load",
		Description: "Load a single record from EvilInsultGenerator. " +
...
func runOp(client *sdk.EvilInsultGeneratorSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.EvilInsultGeneratorSDK, name string) (sdk.EvilInsultGeneratorEntity, error) {
	switch strings.ToLower(name) {
	case "generate_insult":
		return client.GenerateInsult(nil), nil
