...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.EVIL_INSULT_GENERATOR_TEST_LIVE ||
    'TRUE' === process.env.EVIL_INSULT_GENERATOR_TEST_OVERRIDE
  ) {
  ...
  m.EVIL_INSULT_GENERATOR_TEST_EXPLAIN = process.env.EVIL_INSULT_GENERATOR_TEST_EXPLAIN || m.EVIL_INSULT_GENERATOR_TEST_EXPLAIN
