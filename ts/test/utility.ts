...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.EVILINSULTGENERATOR_TEST_LIVE ||
    'TRUE' === process.env.EVILINSULTGENERATOR_TEST_OVERRIDE
  ) {
  ...
  m.EVILINSULTGENERATOR_TEST_EXPLAIN = process.env.EVILINSULTGENERATOR_TEST_EXPLAIN || m.EVILINSULTGENERATOR_TEST_EXPLAIN
