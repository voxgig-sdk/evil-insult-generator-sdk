# EvilInsultGenerator SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EvilInsultGeneratorSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EvilInsultGeneratorSDK(...) and EvilInsultGeneratorSDK.test(...) become
#      EvilInsultGeneratorSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "evilinsultgenerator_sdk"
_SDK_CLASS = "EvilInsultGeneratorSDK"
...
_ENTITIES = {
    "GenerateInsult": "generate_insult",
}
