...
from evilinsultgenerator_sdk.utility import register

# Load features
from evilinsultgenerator_sdk.feature.base_feature import EvilInsultGeneratorBaseFeature
from evilinsultgenerator_sdk.features import _make_feature
...
class EvilInsultGeneratorSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = EvilInsultGeneratorUtility()
        self._utility = utility

        from evilinsultgenerator_sdk.config import make_config
        config = make_config()
    ...
    def get_utility(self):
        return EvilInsultGeneratorUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EvilInsultGeneratorSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GenerateInsult(self, data=None) -> "GenerateInsultEntity":
        ...
        from evilinsultgenerator_sdk.entity.generate_insult_entity import GenerateInsultEntity
