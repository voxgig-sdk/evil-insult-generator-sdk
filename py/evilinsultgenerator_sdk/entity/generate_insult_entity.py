...
from evilinsultgenerator_sdk.evilinsultgenerator_types import (
    GenerateInsult,
...
class GenerateInsultEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return GenerateInsultEntity(self._client, opts)
    ...
    def data_get(self) -> GenerateInsult:
    ...
    def match_get(self) -> GenerateInsult:
    ...
    def load(self, reqmatch=None, ctrl=None) -> GenerateInsult:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.GenerateInsult().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
