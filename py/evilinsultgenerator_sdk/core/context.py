...
from evilinsultgenerator_sdk.core.control import EvilInsultGeneratorControl
...
from evilinsultgenerator_sdk.core.helpers import get_ctx_prop, to_map
...
class EvilInsultGeneratorContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = EvilInsultGeneratorControl()
        ...
        if isinstance(sp, EvilInsultGeneratorSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, EvilInsultGeneratorResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EvilInsultGeneratorResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return EvilInsultGeneratorOperation({})
    ...
    def make_error(self, code, msg):
        return EvilInsultGeneratorError(code, msg, self)
