...
#      offline in seeded test mode (EvilInsultGeneratorSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "EvilInsultGenerator_sdk.rb")
  SDK_CLASS = "EvilInsultGeneratorSDK"
  ...
  SDK_BASE = "EvilInsultGenerator_sdk"
