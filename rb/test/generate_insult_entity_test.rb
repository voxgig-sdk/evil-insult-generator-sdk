...
class GenerateInsultEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set EVILINSULTGENERATOR_TEST_GENERATE_INSULT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def generate_insult_basic_setup(extra)
  ...
  entid_env_raw = ENV["EVILINSULTGENERATOR_TEST_GENERATE_INSULT_ENTID"]
