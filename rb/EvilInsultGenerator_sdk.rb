...
require_relative 'EvilInsultGenerator_types'
...
class EvilInsultGeneratorSDK
  ...
  def initialize(options = {})
    ...
    utility = EvilInsultGeneratorUtility.new
    @_utility = utility
    ...
    feature_opts = EvilInsultGeneratorHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = EvilInsultGeneratorHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, EvilInsultGeneratorFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    EvilInsultGeneratorUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = EvilInsultGeneratorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = EvilInsultGeneratorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = EvilInsultGeneratorHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
    ...
    ctx.spec = EvilInsultGeneratorSpec.new({
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => EvilInsultGeneratorError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue EvilInsultGeneratorError => err
    ...
    if fetched.is_a?(Hash)
      status = EvilInsultGeneratorHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = EvilInsultGeneratorError.new(
        "graphql_error", "EvilInsultGeneratorSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = EvilInsultGeneratorSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
