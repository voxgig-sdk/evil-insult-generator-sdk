...
AQL-driven CLI and REPL for the EvilInsultGenerator SDK. Positional arguments are
...
```sh
go build -o evil-insult-generator-cli ./...
```
...
./evil-insult-generator-cli list generate_insult
./evil-insult-generator-cli load 1 generate_insult
./evil-insult-generator-cli load '{id:1}' generate_insult
