...
func registerSDKWords(r *eng.Registry, client *sdk.EvilInsultGeneratorSDK) {
...
func runOp(client *sdk.EvilInsultGeneratorSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
