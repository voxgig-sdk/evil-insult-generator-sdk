...
// EvilInsultGenerator SDK utility: fetcher

class EvilInsultGeneratorFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EvilInsultGeneratorSDK/1.0)';
    ...
    public static function call(EvilInsultGeneratorContext $ctx, string $fullurl, array $fetchdef): array
    {
