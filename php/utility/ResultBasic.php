...
// EvilInsultGenerator SDK utility: result_basic

class EvilInsultGeneratorResultBasic
{
    public static function call(EvilInsultGeneratorContext $ctx): ?EvilInsultGeneratorResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof EvilInsultGeneratorError) ? $result->err->msg : (string)$result->err;
