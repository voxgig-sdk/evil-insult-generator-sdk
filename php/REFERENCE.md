# EvilInsultGenerator PHP SDK Reference

Complete API reference for the EvilInsultGenerator PHP SDK.
...
#### `EvilInsultGeneratorSDK::test($testopts = null, $sdkopts = null)`
