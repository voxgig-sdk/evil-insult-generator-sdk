...
class GenerateInsultEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set EVIL_INSULT_GENERATOR_TEST_GENERATE_INSULT_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $generate_insult_ref01_data_dt0_loaded = $generate_insult_ref01_ent->load($generate_insult_ref01_match_dt0, null);
...
function generate_insult_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("EVIL_INSULT_GENERATOR_TEST_GENERATE_INSULT_ENTID");
