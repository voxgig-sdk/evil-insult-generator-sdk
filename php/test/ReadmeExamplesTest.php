...
// EvilInsultGenerator SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EvilInsultGeneratorSDK::test)
...
{
    private const SDK_CLASS = 'EvilInsultGeneratorSDK';
    ...
    private const SDK_BASE = 'evilinsultgenerator_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../evilinsultgenerator_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
