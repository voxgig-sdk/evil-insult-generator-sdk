...
// EvilInsultGenerator SDK streaming feature
...
class EvilInsultGeneratorStreamingFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _iterate(EvilInsultGeneratorResult $result): \Generator
    {
    ...
    private function _streamable(EvilInsultGeneratorContext $ctx): bool
    {
