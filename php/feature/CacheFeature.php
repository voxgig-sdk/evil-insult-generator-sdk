...
// EvilInsultGenerator SDK cache feature
...
class EvilInsultGeneratorCacheFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _through(EvilInsultGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
