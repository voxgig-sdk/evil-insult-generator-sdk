...
// EvilInsultGenerator SDK proxy feature
...
class EvilInsultGeneratorProxyFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    public function init(EvilInsultGeneratorContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EvilInsultGeneratorContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
