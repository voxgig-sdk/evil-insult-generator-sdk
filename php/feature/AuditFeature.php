...
// EvilInsultGenerator SDK audit feature
...
class EvilInsultGeneratorAuditFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _emit(EvilInsultGeneratorContext $ctx, string $outcome): void
    {
