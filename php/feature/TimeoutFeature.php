...
// EvilInsultGenerator SDK timeout feature
...
class EvilInsultGeneratorTimeoutFeature extends EvilInsultGeneratorBaseFeature
{
    ...
    private function _with_timeout(EvilInsultGeneratorContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EvilInsultGeneratorContext $_ctx, float $ms): void
    {
        $client = $this->client;
