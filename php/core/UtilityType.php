...
// EvilInsultGenerator SDK utility type

class EvilInsultGeneratorUtility
{
    ...
    public static function copy(EvilInsultGeneratorUtility $src): EvilInsultGeneratorUtility
    {
        $u = new EvilInsultGeneratorUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
